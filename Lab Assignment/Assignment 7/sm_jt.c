...
int exec(){
    ...
    static const void* jumpTable[17] = {&&L0, &&L1, &&L2, &&L3, &&L4, &&DEFAULT, &&L6, &&L7, &&L8, &&L9, &&La, &&Lb, &&Lc, &&Ld, &&Le, &&Lf, &&DEFAULT};
...
L6:
    //if (insOp0 < 0 || insOp0 > 7 || insOp0 != 0xf) goto DEFAULT;
    //goto *jumpTable2[insOp0];
    
    // static const void* jumpTable2[10] = {&&S0, &&S2, &&S3, &&S4, &&S5, &&S6, &&S7, &&SF, &&DEF};
